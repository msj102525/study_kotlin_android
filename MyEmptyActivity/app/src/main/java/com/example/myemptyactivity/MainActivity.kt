...
@Composable
fun Greeting(name: String, viewModel: MyStudyViewModel, modifier: Modifier = Modifier) {
        ...
        Column(
            ...
            Row {
                Button(
                    ...
                    onClick = { viewModel.changeName("윤석열") }
                ) {
                    Text(text = stringResource(R.string.button1))
                }
                Button(
                    modifier = Modifier.padding(end = 8.dp),
                    onClick = { viewModel.changeName("이재명") }
                ) {
            ...
            Row {
                Button(
                    modifier = Modifier.padding(end = 8.dp),
                    onClick = { viewModel.changeName("최순실") }
                ) {
                    Text(text = stringResource(R.string.button3))
                }
                Button(
                    modifier = Modifier.padding(end = 8.dp),
                    onClick = { viewModel.changeName("공명") }
                ) {
